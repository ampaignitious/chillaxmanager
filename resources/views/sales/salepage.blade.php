  ...
  {{-- end of the alerts section --}}
        ...
        <div class="row" style="margin-right: 5px; margin-left:5px;">
            <div class=" col-sm-12 border" style="margin-top:15px;">
              <p class="text-center" style="font-size: 20px; margin-top:5px;">Sales section</p>
              <form style="margin-top:5px; margin-bottom:5px;">
                  <input type="text" class="form-control" id="filterInput" onkeyup="filterTable()" placeholder="Search sales per user, date, category">
                </form>
